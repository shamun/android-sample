...
public static b4a.example.myservice _myservice = null;
  public Object[] GetGlobals() {
		return new Object[] {"Main",Debug.moduleToString(b4a.example.main.class),"myService",Debug.moduleToString(b4a.example.myservice.class),"Service",starter.mostCurrent._service};
}
}