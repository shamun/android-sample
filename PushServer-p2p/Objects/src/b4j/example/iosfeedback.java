...
RDebugUtils.currentLine=1441792;
 //BA.debugLineNum = 1441792;BA.debugLine="Public Sub Start";
RDebugUtils.currentLine=1441793;
 //BA.debugLineNum = 1441793;BA.debugLine="bc.LittleEndian = False";
_bc.setLittleEndian(anywheresoftware.b4a.keywords.Common.False);
RDebugUtils.currentLine=1441794;
 //BA.debugLineNum = 1441794;BA.debugLine="buffer.Initialize";
_buffer.Initialize();
RDebugUtils.currentLine=1441795;
 //BA.debugLineNum = 1441795;BA.debugLine="timer1.Initialize(\"timer1\", 1 * DateTime.TicksPer";
_timer1.Initialize(ba,"timer1",(long) (1*anywheresoftware.b4a.keywords.Common.DateTime.TicksPerHour));
RDebugUtils.currentLine=1441796;
 //BA.debugLineNum = 1441796;BA.debugLine="timer1.Enabled = True";
_timer1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
RDebugUtils.currentLine=1441797;
 //BA.debugLineNum = 1441797;BA.debugLine="Connect";
_connect();
...
RDebugUtils.currentLine=1900544;
 //BA.debugLineNum = 1900544;BA.debugLine="Private Sub AStream_Error";
RDebugUtils.currentLine=1900545;
 //BA.debugLineNum = 1900545;BA.debugLine="Log(\"Error: \" & LastException)";
...
RDebugUtils.currentLine=1703936;
 //BA.debugLineNum = 1703936;BA.debugLine="Private Sub AStream_NewData (data() As Byte)";
RDebugUtils.currentLine=1703937;
 //BA.debugLineNum = 1703937;BA.debugLine="Log(\"Feedback data available\")";
anywheresoftware.b4a.keywords.Common.Log("Feedback data available");
RDebugUtils.currentLine=1703938;
 //BA.debugLineNum = 1703938;BA.debugLine="buffer.AddAll(data)";
...
RDebugUtils.currentLine=1769472;
 //BA.debugLineNum = 1769472;BA.debugLine="Private Sub AStream_Terminated";
RDebugUtils.currentLine=1769473;
 //BA.debugLineNum = 1769473;BA.debugLine="Log(\"feedback terminated\")";
anywheresoftware.b4a.keywords.Common.Log("feedback terminated");
RDebugUtils.currentLine=1769474;
 //BA.debugLineNum = 1769474;BA.debugLine="For i = 0 To buffer.Size - 1 Step 38";
{
...
RDebugUtils.currentLine=1769475;
 //BA.debugLineNum = 1769475;BA.debugLine="Dim date() As Byte = SubListToArray(i, 4)";
_date = _sublisttoarray(_i,(int) (4));
RDebugUtils.currentLine=1769476;
 //BA.debugLineNum = 1769476;BA.debugLine="Dim token() As Byte = SubListToArray(i + 6, 32)";
_token = _sublisttoarray((int) (_i+6),(int) (32));
RDebugUtils.currentLine=1769477;
 //BA.debugLineNum = 1769477;BA.debugLine="Log(bc.IntsFromBytes(date)(0))";
anywheresoftware.b4a.keywords.Common.Log(BA.NumberToString(_bc.IntsFromBytes(_date)[(int) (0)]));
RDebugUtils.currentLine=1769478;
 //BA.debugLineNum = 1769478;BA.debugLine="Dim HexToken As String = bc.HexFromBytes(token)";
_hextoken = _bc.HexFromBytes(_token);
RDebugUtils.currentLine=1769479;
 //BA.debugLineNum = 1769479;BA.debugLine="Log($\"Deleting token ${HexToken}\"$)";
...
RDebugUtils.currentLine=1769480;
 //BA.debugLineNum = 1769480;BA.debugLine="Main.db.ExecNonQuery2(\"DELETE FROM tokens WHERE";
...
RDebugUtils.currentLine=1835008;
 //BA.debugLineNum = 1835008;BA.debugLine="Private Sub SubListToArray(st As Int, len As Int)";
RDebugUtils.currentLine=1835009;
 //BA.debugLineNum = 1835009;BA.debugLine="Dim data(len) As Byte";
_data = new byte[_len];
;
RDebugUtils.currentLine=1835010;
 //BA.debugLineNum = 1835010;BA.debugLine="For i = st To st + len - 1";
{
final int step2 = 1;
...
RDebugUtils.currentLine=1835011;
 //BA.debugLineNum = 1835011;BA.debugLine="data(i - st) = buffer.Get(i)";
_data[(int) (_i-_st)] = (byte)(BA.ObjectToNumber(_buffer.Get(_i)));
 }
};
RDebugUtils.currentLine=1835013;
 //BA.debugLineNum = 1835013;BA.debugLine="Return data";
...
RDebugUtils.currentLine=1572864;
 //BA.debugLineNum = 1572864;BA.debugLine="Private Sub Connect";
RDebugUtils.currentLine=1572865;
 //BA.debugLineNum = 1572865;BA.debugLine="If sock.IsInitialized Then sock.Close";
if (_sock.IsInitialized()) { 
_sock.Close();};
RDebugUtils.currentLine=1572866;
 //BA.debugLineNum = 1572866;BA.debugLine="Dim sock As Socket";
_sock = new anywheresoftware.b4a.objects.SocketWrapper();
RDebugUtils.currentLine=1572867;
 //BA.debugLineNum = 1572867;BA.debugLine="sock.InitializeSSL(\"sock\", File.OpenInput(Main.co";
...
RDebugUtils.currentLine=1572868;
 //BA.debugLineNum = 1572868;BA.debugLine="sock.Connect(Main.config.Get(\"iFeedback\"), Main.c";
...
RDebugUtils.currentLine=1572869;
 //BA.debugLineNum = 1572869;BA.debugLine="buffer.Clear";
_buffer.Clear();
...
RDebugUtils.currentLine=1638400;
 //BA.debugLineNum = 1638400;BA.debugLine="Private Sub sock_Connected (Successful As Boolean)";
RDebugUtils.currentLine=1638401;
 //BA.debugLineNum = 1638401;BA.debugLine="If Successful Then";
if (_successful) { 
RDebugUtils.currentLine=1638402;
 //BA.debugLineNum = 1638402;BA.debugLine="Log(\"Feedback Socket connected.\")";
anywheresoftware.b4a.keywords.Common.Log("Feedback Socket connected.");
RDebugUtils.currentLine=1638403;
 //BA.debugLineNum = 1638403;BA.debugLine="If astream.IsInitialized Then astream.Close";
if (_astream.IsInitialized()) { 
_astream.Close();};
RDebugUtils.currentLine=1638404;
 //BA.debugLineNum = 1638404;BA.debugLine="astream.Initialize(sock.InputStream, sock.Output";
_astream.Initialize(ba,_sock.getInputStream(),_sock.getOutputStream(),"astream");
 }else {
RDebugUtils.currentLine=1638406;
 //BA.debugLineNum = 1638406;BA.debugLine="Log(\"Error connecting feedback socket: \" & LastE";
...
RDebugUtils.currentLine=1507328;
 //BA.debugLineNum = 1507328;BA.debugLine="Sub Timer1_Tick";
RDebugUtils.currentLine=1507329;
 //BA.debugLineNum = 1507329;BA.debugLine="Connect";
_connect();
