...
try {
		Debug.PushSubsStack("AStream_Error (iosfeedback) ","iosfeedback",1,iosfeedback.ba,iosfeedback.mostCurrent,65);
...
try {
		Debug.PushSubsStack("AStream_NewData (iosfeedback) ","iosfeedback",1,iosfeedback.ba,iosfeedback.mostCurrent,40);
...
try {
		Debug.PushSubsStack("AStream_Terminated (iosfeedback) ","iosfeedback",1,iosfeedback.ba,iosfeedback.mostCurrent,45);
...
try {
		Debug.PushSubsStack("Connect (iosfeedback) ","iosfeedback",1,iosfeedback.ba,iosfeedback.mostCurrent,22);
...
try {
		Debug.PushSubsStack("sock_Connected (iosfeedback) ","iosfeedback",1,iosfeedback.ba,iosfeedback.mostCurrent,30);
...
try {
		Debug.PushSubsStack("Start (iosfeedback) ","iosfeedback",1,iosfeedback.ba,iosfeedback.mostCurrent,10);
...
try {
		Debug.PushSubsStack("SubListToArray (iosfeedback) ","iosfeedback",1,iosfeedback.ba,iosfeedback.mostCurrent,57);
...
try {
		Debug.PushSubsStack("Timer1_Tick (iosfeedback) ","iosfeedback",1,iosfeedback.ba,iosfeedback.mostCurrent,18);
