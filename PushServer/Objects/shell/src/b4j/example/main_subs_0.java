...
main._dbutils.runVoidMethod ("_createtable",(Object)(main._db),(Object)(BA.ObjectToString("tokens")),(Object)(main.__c.runMethod(false, "createMap", (Object)(new RemoteObject[] {RemoteObject.createImmutable(("token")),(main._dbutils._db_text),RemoteObject.createImmutable(("type")),(main._dbutils._db_integer),RemoteObject.createImmutable(("updated_time")),(main._dbutils._db_integer)}))),(Object)(RemoteObject.createImmutable("token")));
 }else {
